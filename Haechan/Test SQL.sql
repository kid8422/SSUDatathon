...
-- 1. 스키마 생성
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `hardcoding3` ;
CREATE SCHEMA IF NOT EXISTS `hardcoding3` DEFAULT CHARACTER SET utf8mb4 ;
SHOW WARNINGS;
USE `hardcoding3` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hardcoding3`.`book` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`book` (
...
DROP TABLE IF EXISTS `hardcoding3`.`rent` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`rent` (
  `ID` VARCHAR(10) NOT NULL,
...
DROP TABLE IF EXISTS `hardcoding3`.`rent_count` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`rent_count` (
  `ID` VARCHAR(10) NOT NULL,
...
DROP TABLE IF EXISTS `hardcoding3`.`recent_rent` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`recent_rent` (
  `ID` VARCHAR(10) NOT NULL,
...
DROP TABLE IF EXISTS `hardcoding3`.`ISBN_rent_count` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`ISBN_rent_count` (
  `ISBN` VARCHAR(20) NOT NULL,
...
DROP TABLE IF EXISTS `hardcoding3`.`None_ISBN_rent_count` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`None_ISBN_rent_count` (
  `title` VARCHAR(510) NOT NULL,
  `author` VARCHAR(160) NULL,
  `publisher` VARCHAR(220) NULL,
  `ID_count` INT UNSIGNED NULL DEFAULT 0,
...
DROP TABLE IF EXISTS `hardcoding3`.`large_classification` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`large_classification` (
...
DROP TABLE IF EXISTS `hardcoding3`.`middle_classification` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`middle_classification` (
  `TAG` VARCHAR(20) NOT NULL,
  `000` INT UNSIGNED NULL DEFAULT 0,
...
DROP TABLE IF EXISTS `hardcoding3`.`year_month_count` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`year_month_count` (
...
DROP TABLE IF EXISTS `hardcoding3`.`year_month_count_detail` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`year_month_count_detail` (
  `year` INT UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS `hardcoding3`.`rent_info` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`rent_info` (
...
DROP TABLE IF EXISTS `hardcoding3`.`DDC_ratio` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`DDC_ratio` (
...
DROP TABLE IF EXISTS `hardcoding3`.`timestamp` ;
SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `hardcoding3`.`timestamp` (
...
BEGIN
    ...
    INSERT IGNORE INTO `hardcoding3`.`large_classification` (TAG) VALUES (location);
    INSERT IGNORE INTO `hardcoding3`.`middle_classification` (TAG) VALUES (location);
    INSERT IGNORE INTO `hardcoding3`.`large_classification` (TAG) VALUES ('전체');
    INSERT IGNORE INTO `hardcoding3`.`middle_classification` (TAG) VALUES ('전체');

    -- 3. large_classification 업데이트 (+1)
    SET @query_large = CONCAT(
        'UPDATE `hardcoding3`.`large_classification` SET `',
    ...
    SET @query_middle = CONCAT(
        'UPDATE `hardcoding3`.`middle_classification` SET `',
...
BEGIN
    ...
    SELECT location, large_code, middle_code
      ...
      FROM `hardcoding3`.`book`
	WHERE ID = book_ID;
     
    UPDATE `hardcoding3`.`book`
...
BEGIN
    ...
    INSERT IGNORE INTO `hardcoding3`.`rent_count` (`ID`) VALUES (rent_id);

    -- rent_count에서 해당 연도 컬럼 +1
    SET @col = CAST(rent_year AS CHAR);
    SET @query = CONCAT(
      'UPDATE `hardcoding3`.`rent_count` SET `',
	...
	INSERT IGNORE INTO `hardcoding3`.`year_month_count_detail` (year, month)
    ...
    SET @query2 = CONCAT(
      'UPDATE `hardcoding3`.`year_month_count_detail` ',
...
BEGIN
    -- 1) rent 테이블에 INSERT
    INSERT INTO `hardcoding3`.`rent` (`ID`, `rent_date`)
...
USE `hardcoding3`$$
DROP TRIGGER IF EXISTS `hardcoding3`.`rent_AFTER_UPDATE` $$
SHOW WARNINGS$$
USE `hardcoding3`$$
CREATE TRIGGER `hardcoding3`.`rent_AFTER_UPDATE`
...
DELIMITER $$
USE `hardcoding3`$$
DROP TRIGGER IF EXISTS `hardcoding3`.`year_month_count_detail_AFTER_INSERT` $$
SHOW WARNINGS$$
USE `hardcoding3`$$
CREATE TRIGGER `hardcoding3`.`year_month_count_detail_AFTER_INSERT`
