...
INSERT INTO `hardcoding`.`timestamp` (`table`) VALUES
...
CREATE INDEX title_idx ON `hardcoding`.`book` (`title`(191));
CREATE INDEX jaum_idx ON `hardcoding`.`book` (`jaum`(191));
CREATE INDEX bulli_idx ON `hardcoding`.`book` (`bulli`(191));
CREATE INDEX rent_time_idx ON `hardcoding`.`rent_info` (`rent_time`);

INSERT INTO `hardcoding`.`large_classification` (`TAG`) VALUES
('보존서고'),
('전체'),
('4층인문');

INSERT INTO `hardcoding`.`middle_classification` (`TAG`) VALUES
('보존서고'),
('전체'),
('4층인문');

INSERT INTO `hardcoding`.`DDC_ratio` (`TAG`) VALUE ('4층인문');

INSERT INTO `hardcoding`.`year_month_count_detail` (`year`, `month`) VALUES
...
INSERT INTO `hardcoding`.`year_month_count` (`year`) VALUES
